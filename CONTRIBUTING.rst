...
5. The next step would be to run the test cases. `cookiecutter-pylib`_ uses py.test, you can run PyTest. Before you run pytest you should ensure all dependancies are installed::
...
.. _`cookiecutter-pylib`: https://github.com/wooyek/cookiecutter-pylib
